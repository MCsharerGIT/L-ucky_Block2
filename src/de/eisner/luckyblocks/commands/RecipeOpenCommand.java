...
import de.eisner.luckyblocks.recipe.RecipeManager;

public class RecipeOpenCommand implements CommandExecutor, TabCompleter {

	@Override
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		if (sender.hasPermission(SettingsManager.PERMISSION) && sender instanceof Player p) {
			p.openInventory(RecipeManager.createGUI());
		}
		return false;
	}
